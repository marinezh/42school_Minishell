...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/07/14 14:39:12 by ikozhina          #+#    #+#             */
/*   Updated: 2025/07/14 14:39:14 by ikozhina         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define ERR_PARSING_NEW "syntax error near unexpected token `newline'\n"
# define ERR_PARSING_OUT "syntax error near unexpected token `>'\n"
